...
CURSOR_SKILL = (ROOT / ".cursor" / "skills" / "humanizer" / "SKILL.md")
README = (ROOT / "README.md").read_text()
PLUGIN = json.loads((ROOT / ".claude-plugin" / "plugin.json").read_text())

if not CURSOR_SKILL.is_file():
    raise SystemExit("Missing Cursor skill at .cursor/skills/humanizer/SKILL.md")

if CURSOR_SKILL.read_text() != SKILL:
    raise SystemExit("Cursor skill is out of sync with SKILL.md — run: Copy-Item SKILL.md .cursor/skills/humanizer/SKILL.md")
